  ...
  return (
    <Container>
      ...
      <div style={{textAlign: "justify"}}>
        ...
        Pharmaceutical Terminology (NPC)</strong>, I became interested in becoming a programmer
        ...
        of <strong>Electronic Medical Prescription (RME)</strong> in a private clinic, my skills
